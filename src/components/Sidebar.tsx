...
// All icon/image assets served directly from the Figma desktop MCP local server
const LOGO          = 'http://localhost:3845/assets/47c7572eb4490c9f7d77e60f4c88930eacb0e2e7.svg'
const PANEL_ICON    = 'http://localhost:3845/assets/7bdaf591680f059473657fe64359ae9ba26c5b86.svg'
const ICON_SCHEDULE = 'http://localhost:3845/assets/7367d7e4687c04f113309cbada646dfc2a4458ac.svg'
const ICON_VISITS   = 'http://localhost:3845/assets/8bc46877cd8b13997030abbacf25006342d44f77.svg'
const ICON_USERS    = 'http://localhost:3845/assets/a9b883c3c1d036682519cdfd2b4a047a325f4342.svg'
const ICON_INSIGHTS = 'http://localhost:3845/assets/3521cb4036939c0796a4b36d59dd1c85af417bfd.svg'
const ICON_BOOKING  = 'http://localhost:3845/assets/65b46c276c34567f2923df47a24fa76988561e7c.svg'
const ICON_BILLING  = 'http://localhost:3845/assets/a32fb1bc6af59c05a29d51b97b67d309f4fb41a6.svg'
const ICON_SETTINGS = 'http://localhost:3845/assets/cf3c8451b69da1a3adbfe9b605364b3897b61f60.svg'
const ICON_CHEVRON  = 'http://localhost:3845/assets/703b89476fa392c60161b4b2ed5842eeffadf3ec.svg'
